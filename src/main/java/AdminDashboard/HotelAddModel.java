...
public class HotelAddModel {
	...
	public HotelAddModel(int id, String name, String location, String description, double singleRate, double doubleRate,
			double suiteRate, double deluxeRate, String rating, String amenities, String imageUrl) {
		super();
		this.id = id;
		this.name = name;
